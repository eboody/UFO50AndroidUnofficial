...
Portrait mode produces `com.unofficial.ufo50.portrait.apk`. Android keeps the app upright in a portrait window while UFO 50 retains its original landscape 16:9 game canvas without stretching or cropping. The canvas is shifted 300 pixels above vertical center, and the exposed background remains black. The normal landscape build remains the default and continues to produce `com.unofficial.ufo50.apk`.
